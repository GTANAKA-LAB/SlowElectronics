...
| ------------- | ------------- | ------------- | ------------ | ----------- |
| Handwriting Triangles (2 persons) **Multi-person data?**| Anomaly detection (for Authentication) | --- | ESN(LR), LSTM(BPTT) | [Inoue et al., IEEE Symposium on VLSI Technology and Circuits, 2023](https://ieeexplore.ieee.org/document/10185412) |
